    ...
    <script>
        ...
        function openIngModal(data = null) {
            ...
            if (data) {
                ...
                // Khi sửa thì ẩn ô giá và bỏ required
                priceGroup.classList.add('hidden');
                const priceInput = document.getElementById('ing_price_per_kg');
                ...
                // Khi thêm thì hiện ô giá và bật lại required
        ...
        async function deleteIng(id) {
            try {
                ...
                // Nếu nguyên liệu đang được dùng trong món ăn
                if (data.status === "confirm") {

                    let text =
                        "⚠️ Nguyên liệu này đang được sử dụng trong các món sau:\n\n";

                    data.dishes.forEach(d => {
                        text += "• " + d + "\n";
                    });

                    text += "\nNếu tiếp tục, hệ thống sẽ xóa:\n";
                    text += "• Nguyên liệu này\n";
                    text += "• Toàn bộ các món ăn trên\n";
                    text += "• Liên kết với thực đơn\n";
                    text += "• Lịch sử giá của nguyên liệu\n\n";
                    text += "Hành động này KHÔNG THỂ hoàn tác.\n\n";
                    text += "Bạn vẫn muốn tiếp tục?";
