    ...
    <script>
        ...
        window.loadData = async function () {
            try {
                ...
                allIngredients = (result.data || []).map(item => ({
                    ...item,
                    // luôn dùng giá hiện tại từ API
        ...
        `).join('')}
                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                    <div class="flex items-center bg-gray-100 px-2 rounded-md">
                                                                                                                                                                                                                                        <input type="number" min="0" step="any" placeholder="0" class="w-16 bg-transparent border-none p-1 text-sm ing-weight focus:ring-0 text-right" oninput="calculateNutrients()">
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            window.getUiDescription = () =>
                "Giao diện: 'Kho món ăn' của Nhân viên.\n" +
                "1. Bộ lọc: Ô tìm kiếm món ăn theo Tên món ăn.\n" +
                "2. Nút 'Tạo Món Ăn Mới': Dùng để thiết lập công thức món ăn mới. Form gồm: Ô Tên món ăn, Ô selectbox chọn 'Loại món ăn' (Món chính, món phụ, canh, khai vị, tráng miệng), Ô nhập 'Số suất tạo ra' và Bảng chọn 'Nguyên liệu thành phần'. Tại bảng nguyên liệu, có thể chọn đơn vị tính là Kilogam hoặc Gam, sau đó chọn từng thực phẩm và nhập khối lượng tương ứng. Hệ thống sẽ TỰ ĐỘNG TÍNH TOÁN: Tổng năng lượng (Kcal) và Giá vốn ước tính dựa trên định lượng và giá nguyên liệu của doanh nghiệp.\n" +
                "3. Thao tác trên Danh sách món ăn (Ẩn/Hiện động): Người dùng phải DI CHUỘT VÀO món ăn thì mới xuất hiện 2 nút chức năng: Nút hình cây bút (Chỉnh sửa công thức - hiển thị đầy đủ các ô như form tạo mới) và Nút hình thùng rác (Xóa món ăn).\n" +
                "⚠️ ĐẶC TÍNH TỰ ĐỘNG: Món ăn sau khi tạo sẽ tự động KẾ THỪA toàn bộ các Tag cảnh báo (Dị ứng/Tôn giáo) từ các nguyên liệu thành phần tạo nên nó.\n" +
                "➡️ THỨ TỰ THỰC HIỆN: Ấn 'Tạo món ăn mới' -> Chọn loại món -> Bốc nguyên liệu và điền khối lượng kg/g -> Hệ thống tự tính kcal và giá vốn -> Ấn lưu -> Di chuột vào từng món ở danh sách nếu muốn Sửa/Xóa.";
        });
    </script>
@endsection